        ...
        <div class="py-5">
            <div class="container bg-light shadow mx-auto p-5 d-flex flex-column gap-2">
                <div class="d-flex flex-column align-items-center gap-4">
                    ...
                    <div class="d-flex flex-column gap-2 info text-center">
                        <h1>{{ $item->name }}</h1>
                ...
                <div class="d-flex justify-content-center mt-3">
                    <div class="text-center w-50">
                        ...
                        <button class="btn btn-success btn-lg py-2" id="pay-button" onclick="generateToken()">Pay Now <div
                                class="spinner-grow spinner-grow-sm d-none" id="loader" role="status"></div></button>
                    </div>
                </div>
