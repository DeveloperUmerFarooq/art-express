<header>
    <nav class="navbar navbar-expand-lg">
        <div class="container">
          ...
          <a href="{{route('user.profile')}}" class="nav-link dropdown-toggle no-togggle-icon fs-6 ms-auto mx-1 d-md-none">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <li><center>
                    <a class="d-flex flex-column text-decoration-none gap-1 pb-0" href="{{route('user.profile')}}">
                        ...
                        <img loading="lazy" class="rounded-circle" src="{{asset('storage/users-avatar/'.auth()->user()->avatar)}}" style="height: 4rem; width: 4rem" alt="{{auth()->user()->name}}">
                        </div>
