          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto gap-2 text-center">
              ...
              <li class="nav-item pt-1">
                ...
                @endphp
                @if ($unreadCount>0)
                <span class="bg-danger p-2 rounded-pill text-white fw-bold d-inline-flex align-items-center justify-content-center" style="min-width: 24px; height: 24px; font-size: 0.8rem;">
                    {{$unreadCount}}
                </span>
                @endif
                Messages
